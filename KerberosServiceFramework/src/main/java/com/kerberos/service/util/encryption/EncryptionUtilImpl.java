 ...
 * 
 */
package com.kerberos.service.util.encryption;
...
public class EncryptionUtilImpl implements IEncryptionUtil {
	...
	@Override
	public boolean validateDecryptedAttributes(String... attributes) throws InvalidAttributeValueException{
		if (attributes == null){
			throw new InvalidAttributeValueException(this.getClass().getName()+": Input paramter to validateDecryptedAttributes can not be null");
		}
