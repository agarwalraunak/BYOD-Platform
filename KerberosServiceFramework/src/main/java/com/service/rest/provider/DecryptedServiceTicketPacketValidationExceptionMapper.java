package com.service.rest.provider;
...
import com.service.rest.error.ErrorResponse;
import com.service.rest.exception.common.InternalSystemException;

@Provider
public class DecryptedServiceTicketPacketValidationExceptionMapper implements ExceptionMapper<InternalSystemException>{
