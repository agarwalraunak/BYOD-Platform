...
public class KerberosServiceTicketClient {
	...
	public ServiceTicket getServiceTicketForApp(String serviceName) {
		...
		String expriryTimeStr = responseAttributes.get(ServiceTicketResponseAttributes.EXPIRY_TIME);
		
		Date expiryTime = iDateUtil.generateDateFromString(expriryTimeStr);
