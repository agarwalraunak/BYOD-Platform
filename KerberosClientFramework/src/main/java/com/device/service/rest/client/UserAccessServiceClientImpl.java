...
import com.device.service.rest.api.IUserAccessServiceAPI;
 ...
 */
@Component
public class UserAccessServiceClientImpl implements IUserAccessServiceClient{
	
	private static Logger log = Logger.getLogger(UserAccessServiceClientImpl.class);
	
	private @Autowired IDateUtil iDateUtil;
	private @Autowired IEncryptionUtil iEncryptionUtil;
	private @Autowired IUserAccessServiceAPI iClientAccessServiceAPI;
