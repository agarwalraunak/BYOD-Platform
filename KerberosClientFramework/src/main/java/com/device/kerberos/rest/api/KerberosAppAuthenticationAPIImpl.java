...
import com.device.kerberos.rest.representation.AuthenticationResponse;
 ...
 */
@Component
public class KerberosAppAuthenticationAPIImpl implements IKerberosAppAuthenticationAPI{
	...
	private static Logger log = Logger.getLogger(KerberosAppAuthenticationAPIImpl.class);
	...
	public Map<AuthenticationResponseAttributes, String> authenticate(String url, String loginName, String password, boolean isApplication) throws IOException, NoSuchAlgorithmException, InvalidAttributeValueException{
		...
		//Check if the url ends with front slash, otherwise add one
		StringBuilder builder = new StringBuilder(url);
		if (!url.endsWith("/")) {
			builder.append("/");
		}
		String authenticationUrl = builder.append(loginName).toString();
